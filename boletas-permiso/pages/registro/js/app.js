  ...
  var ot         = button.data('ot') // Extraer la información de atributos de datos
  var idot       = button.data('idot') // Extraer la información de atributos de datos
  ...
  var tipo       = button.data('tipo') // Extraer la información de atributos de datos
		  ...
		  var modal = $(this)
		  modal.find('.modal-title').text('Modificar OT: '+ot)
		  modal.find('.modal-body #id').val(id)
		  modal.find('.modal-body #fecha').val(fecha)
		  modal.find('.modal-body #ot').val(ot)
		  modal.find('.modal-body #idot').val(idot)
